...
ar5k_ar5212_set_beacon_timers(struct ath_hal *hal, const HAL_BEACON_STATE *state)
{
...
HAL_BOOL /*O.K.*/
ar5k_ar5212_wait_for_beacon(struct ath_hal *hal, HAL_BUS_ADDR phys_addr)
{
	HAL_BOOL ret;
